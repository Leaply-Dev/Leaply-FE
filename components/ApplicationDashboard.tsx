            ...
            <CardContent>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-linear-to-br from-leaf-green/10 to-light-green/10 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-primary">{application.completionPercentage}%</p>
                </div>
                ...
                <div className="bg-chart-2/10 rounded-lg p-4">
                  ...
                  <p className="text-2xl font-bold text-chart-2">{application.documents.length}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    <StatusIcon className={cn(
                      ...
                      config.variant === 'warning' && 'text-chart-4 bg-orange-50',
                      config.variant === 'info' && 'text-chart-2 bg-sky-50',
                      config.variant === 'destructive' && 'text-red-600 bg-red-50',
                      config.variant === 'secondary' && 'text-muted-foreground bg-muted',
                    )} />
                    <div>
                ...
                {/* Next Deadline */}
                <div className="space-y-3">
                  <span className="text-sm font-semibold text-foreground">Next Deadline</span>
                  {nextDeadline ? (
                    <div className={cn(
                      ...
                      <p className={cn(
                        'text-xs font-bold',
                        nextDeadline.daysUntil <= 7 ? 'text-red-600' : 'text-primary'
                      )}>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {application.weaknesses.map((weakness, idx) => (
                          <li key={idx} className="text-sm text-muted-foreground flex gap-2">
                            <span className="text-chart-4 font-bold">{idx + 1}.</span>
                            <span>{weakness}</span>
                          </li>
                        ))}
                      </ul>
            ...
            <CardContent className="space-y-3 flex-1 flex flex-col">
              <div className="grid grid-cols-2 gap-4 flex-1">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{application.universityRegion}</p>
                </div>
                ...
                {application.tuitionRange && (
                  <div className="col-span-2">
                    <p className="text-xs text-muted-foreground mb-1">Tuition Range</p>
                    <div className="flex items-center gap-1">
                      ...
                      return (
                        <div 
                          ...
                          className={cn(
                            ...
                            isUrgent ? 'border-red-200 bg-red-50' : 'border-border bg-card'
                          )}
                        >
                          <Checkbox 
                            id={task.id}
                    ...
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        <div className="text-left">
                          ...
                          <p className="text-xs text-muted-foreground">Tips for compelling statements</p>
                        </div>
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>
