import { ArrowUp, Lightbulb, Sparkles, User, Wand2 } from "lucide-react";
				...
				<div className="flex items-center gap-2 bg-muted/50 p-1 rounded-full border border-border">
					...
					<button
						...
						className={cn(
							"px-3 py-1.5 rounded-full text-xs font-medium transition-all",
							mode === "persona"
								? "bg-linear-to-r from-primary/20 to-purple-500/20 text-primary shadow-sm border border-primary/10"
								: "text-muted-foreground hover:text-foreground",
						)}
					>
						Persona Lab
				...
				<div className="space-y-6 max-w-3xl mx-auto pb-4">
						...
						>
							<div
								className={cn(
									...
									msg.role === "ai"
										? "bg-linear-to-br from-primary to-purple-600 text-white shadow-lg shadow-primary/20"
					...
					{isTyping && (
						<div className="flex gap-4">
							<div className="w-8 h-8 rounded-full bg-linear-to-br from-primary to-purple-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-primary/20">
								<Sparkles className="w-4 h-4 animate-pulse" />
							</div>
							<div className="bg-muted/50 border border-border p-4 rounded-2xl rounded-tl-none flex items-center gap-1">
				...
				<div className="max-w-3xl mx-auto space-y-4">
					...
					<div className="relative flex items-end gap-2 bg-muted/30 p-2 rounded-xl border border-border focus-within:border-primary/50 focus-within:ring-1 focus-within:ring-primary/20 transition-all shadow-sm">
						...
						<textarea
							...
							className="flex-1 bg-transparent border-0 focus:ring-0 p-2.5 min-h-[44px] max-h-[120px] resize-none text-sm text-foreground placeholder:text-muted-foreground"
							rows={1}
						/>
					...
					<p className="text-center text-[10px] text-muted-foreground">
						Leaply AI can make mistakes. Consider checking important
						information.
					</p>
				</div>
			</div>
