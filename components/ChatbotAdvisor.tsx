...
import { Loader2, Phone, Send, Sparkles, User as UserIcon } from "lucide-react";
...
const SYSTEM_MESSAGE =
	"Hi, I'm Leafy, your AI study-abroad advisor! 🌿 I'm here to help you navigate the university application process. I can provide information about admissions, scholarships, essays, and more. Please note that I'm an AI assistant and my suggestions are for informational purposes only.";
...
export function ChatbotAdvisor({ profileContext }: ChatbotAdvisorProps) {
	...
	return (
		<div className="flex flex-col h-full">
			...
			<Dialog
				open={showHumanAdvisorDialog}
				onOpenChange={setShowHumanAdvisorDialog}
			>
				<DialogContent>
					<DialogHeader>
						<DialogTitle>Connect with a Human Advisor</DialogTitle>
						<DialogDescription>
							While Leafy can provide helpful information, sometimes you need
							personalized guidance from a real person.
						</DialogDescription>
					</DialogHeader>
					<div className="py-4">
						<Card>
							<CardContent className="pt-6">
								<div className="text-center">
									...
									<p className="text-sm text-muted-foreground mb-4">
										Our expert advisors can provide personalized guidance on
										university selection, application strategy, and more.
									</p>
