...
export default async function OnboardingPage({
	...
	const translations = {
		...
		step2: {
			...
			timeline: dict.onboarding.step2.timeline,
			timelineRequired: dict.onboarding.step2.timelineRequired,
			selectYear: dict.onboarding.step2.selectYear,
			selectYearPlaceholder: dict.onboarding.step2.selectYearPlaceholder,
			selectTerm: dict.onboarding.step2.selectTerm,
			selectTermPlaceholder: dict.onboarding.step2.selectTermPlaceholder,
			budget: dict.onboarding.step2.budget,
			budgetRequired: dict.onboarding.step2.budgetRequired,
		},
		step3: {
