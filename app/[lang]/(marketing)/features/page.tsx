										...
										<div key={benefit.titleKey} className="flex gap-4">
											...
											<div>
												<h3 className="font-semibold text-foreground mb-1">
													{t("features", benefit.titleKey)}
												</h3>
												<p className="text-muted-foreground text-sm">
													{t("features", benefit.descKey)}
												</p>
											</div>
										</div>
									);
							...
							<div className="relative aspect-4/3 rounded-2xl overflow-hidden bg-linear-to-br from-muted to-muted/50 border border-border shadow-xl">
								<div className="absolute inset-0 flex items-center justify-center">
									<div className="text-center p-8">
										...
										<p className="text-muted-foreground text-sm">
											{t("features", feature.titleKey)} Preview
										</p>
									</div>
								</div>
							</div>
						...
						<SlideUp>
							...
							<div className="flex flex-col sm:flex-row gap-4 justify-center">
								...
								<Button
									...
									asChild
								>
									<Link href="/about">{t("features", "aboutUs")}</Link>
								</Button>
							</div>
						</SlideUp>
					</div>
