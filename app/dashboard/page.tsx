...
import { GraduationCap, FileText, CheckSquare, BookOpen, ArrowRight } from 'lucide-react';
...
export default function DashboardPage() {
  const { universities, setUniversities, savedUniversities } = useUniversitiesStore();
  const { applications, tasks, setApplications, setTasks, toggleTaskComplete } = useApplicationsStore();
  ...
  }, [universities.length, applications.length, tasks.length, setUniversities, setApplications, setTasks]);
