...
import {
	PersonaLabProfile,
	type ProfileConfig,
} from "@/components/PersonaLabProfile";

export default function AIPage() {
	const [activeTab, setActiveTab] = useState("chatbot");
	const [profileContext, setProfileContext] = useState<ProfileConfig | null>(
		null,
	);
					...
					<div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="text-center">
							...
							<p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
								Get personalized guidance with our AI chatbot advisor and
								discover your perfect university matches with Persona Lab
							</p>
						</div>
					</div>
				</section>
					...
					>
										...
										<div className="space-y-4">
											<div>
												...
												<p className="text-sm text-muted-foreground leading-relaxed">
													Your AI study-abroad advisor. Get instant answers
													about admissions, scholarships, essays, and more.
												</p>
											</div>
											...
											<div className="pt-4 border-t border-border">
												...
												<p className="text-xs text-muted-foreground">
													Responses are generated by AI and are for
									...
									<Card className="p-4 bg-card">
										...
										<ul className="space-y-2 text-xs text-muted-foreground">
											...
											<li className="flex items-start gap-2">
												<span className="text-primary">•</span>
												<span>
													Use Persona Lab to create your profile first
												</span>
											</li>
											<li className="flex items-start gap-2">
												<span className="text-primary">•</span>
											...
											<li className="flex items-start gap-2">
												<span className="text-primary">•</span>
												<span>
													Contact a human advisor for personalized guidance
												</span>
											</li>
										</ul>
									</Card>
						...
						<TabsContent value="persona-lab" className="mt-0">
							<div className="space-y-6">
								{/* Header Info */}
								<Card className="p-6 bg-linear-to-r from-chart-2/10 via-primary/10 to-chart-4/10 border-primary/20">
									<div className="flex items-start gap-4">
										...
										<div className="flex-1">
											...
											<p className="text-sm text-muted-foreground mb-4 leading-relaxed">
												Adjust your academic profile using the sliders below to
												see real-time university matches. Each recommendation
												includes a fit score and personalized match reasons
								...
								{/* How It Works */}
								<Card className="p-6 bg-linear-to-r from-chart-2/10 to-primary/10 border-chart-2/20">
									...
									<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
										<div className="text-center p-4">
											...
											<p className="text-xs text-muted-foreground">
												Use sliders to set your GPA, test scores, budget, and
												preferences
											</p>
										</div>
										<div className="text-center p-4">
											...
											<p className="text-xs text-muted-foreground">
												View universities ranked by fit score with detailed
												match reasons
											</p>
										</div>
										<div className="text-center p-4">
											...
											<p className="text-xs text-muted-foreground">
												Send your profile to our AI chatbot for detailed
												analysis
											</p>
										</div>
									</div>
