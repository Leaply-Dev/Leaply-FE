...
import { GraduationCap, Brain, Target, Globe, ArrowRight, Sparkles, Users, FileCheck, Bot, User } from 'lucide-react';
...
function ParallaxVisual() {
  ...
  return (
    <div 
      className="relative w-full h-full bg-card rounded-2xl shadow-2xl p-8 overflow-hidden"
    >
      {/* Background gradient */}
      <motion.div
          ...
          {[1, 2, 3, 4].map((step) => (
            <div
              ...
              style={{
                ...
                backgroundColor: step === activeStep ? currentVisual.color : undefined,
              }}
            />
          ))}
        </div>
