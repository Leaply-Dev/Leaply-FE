...
export default function ChatbotPage() {
  const { currentConversationId, getCurrentConversation, createConversation, addMessage, isTyping, setTyping } = useChatStore();
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      ...
      if (userMessage.toLowerCase().includes('university') || userMessage.toLowerCase().includes('recommend')) {
        response = mockAIResponses.universities;
      } else if (userMessage.toLowerCase().includes('essay') || userMessage.toLowerCase().includes('statement')) {
