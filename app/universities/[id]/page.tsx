                ...
                <div className="absolute inset-0 flex items-end p-8">
                  <div className="text-white">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      ...
                      {university.type && (
                        <Badge variant="secondary" className="capitalize bg-card/20 backdrop-blur-sm border-white/30 text-white">
                          {university.type}
                        </Badge>
                      )}
                    </div>
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="flex items-center gap-3 p-4 bg-muted rounded-lg">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-foreground">#{university.ranking}</p>
                  ...
                  {university.acceptanceRate && (
                    <div className="flex items-center gap-3 p-4 bg-muted rounded-lg">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-foreground">{university.acceptanceRate}%</p>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-muted rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Avg. Tuition/Year</p>
                    </div>
                  </div>
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <div className="flex gap-1">
                            {[...Array(review.rating)].map((_, i) => (
                              <Star key={i} className="w-4 h-4 fill-warning-orange text-chart-4" />
                            ))}
                          </div>
              ...
              <Card>
                ...
                <CardContent>
                  {university.programs && university.programs.length > 0 ? (
                    ...
                    <p className="text-muted-foreground">Program information coming soon.</p>
                  )}
                </CardContent>
              </Card>
            </SlideUp>
                      ...
                      {university.applicationRequirements.map((req, idx) => (
                        <div key={idx} className="flex gap-4">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-foreground mb-1">{req.type}</h3>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {university.scholarships.map(scholarship => (
                      <div key={scholarship.id} className="p-4 border border-border rounded-lg">
                        <div className="flex items-start justify-between mb-2">
