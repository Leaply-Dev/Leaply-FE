...
const essayBlueprints = [
	{
		...
		description:
			"The project that flopped. Plot twist: What you learned became your superpower.",
		prompt:
			"What unexpected experience challenged your assumptions and led you to see the world differently?",
	...
	},
	{
		...
		description:
			"Between two worlds. How you became a bridge between cultures.",
		prompt:
			"Describe how navigating different cultural worlds has shaped your identity and perspective.",
	...
	},
	{
		...
		description:
			"That weird hobby. How it revealed something profound about you.",
		prompt:
			"What unusual interest or hobby taught you something deeper about yourself?",
	...
	},
	{
		...
		description:
			"Not the president—the one who makes it work. Impact without spotlight.",
		prompt:
			"Describe a time when you made a significant impact without being in the spotlight.",
	...
	},
	{
		...
		description:
			"Daily routines. Finding profound lessons in everyday rhythms.",
		prompt:
			"What everyday activity or routine has taught you something profound?",
	...
	},
	{
		...
		description:
			"Math nerd who loves poetry. Embracing complexity, refusing labels.",
		prompt:
			"How do you embrace the contradictions in your identity or interests?",
...
export default function PersonaLabPage() {
	const [selectedBlueprint, setSelectedBlueprint] = useState<number | null>(
		null,
	);
						...
						<div className="text-center">
							<SlideUp>
								...
								<p className="text-xl text-white/90 max-w-2xl mx-auto">
									Discover your unique story and craft compelling essays with
									AI-powered guidance
								</p>
							</SlideUp>
						</div>
						...
						<div className="mb-8">
							<div className="mb-6">
								...
								<p className="text-muted-foreground">
									I've analyzed thousands of successful essays. Here are{" "}
									<strong>6 clever blueprints</strong> that make admissions
									officers stop and read:
								</p>
							</div>
							...
							<SlideUp delay={0.1}>
								<Card>
									<CardHeader>
										<CardTitle>
											{selectedBlueprint
												? essayBlueprints.find(
														(b) => b.id === selectedBlueprint,
													)?.title
								...
								<Card className="sticky top-24">
									...
									<CardContent>
										<div className="space-y-3">
											{selfDiscoveryQuestions.map((question, idx) => (
												<button
													type="button"
													key={`question-${idx}`}
													onClick={() =>
								...
								<div className="flex items-center gap-3">
									...
									<div>
										<CardTitle className="text-white mb-1">
											LeapBot - Your AI Coach
										</CardTitle>
										<p className="text-sm text-white/90">
											Ask me anything about essays, applications, or profile
											building
										</p>
									</div>
								</div>
								...
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="text-sm text-muted-foreground mb-3">
											They're about <strong>authentic reflection</strong>. Our
											AI analyzes thousands of successful essays to help you
											discover your unique narrative. Choose a blueprint above,
											answer prompts honestly, and chat with LeapBot to refine
											your story into something admissions officers will
											remember.
										</p>
