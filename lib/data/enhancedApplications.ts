import type { Application } from "../store/applicationsStore";
		...
		tasks: [
			{
				...
				description: "Craft a compelling personal statement",
				dueDate: "2024-10-20",
				completed: true,
			},
			{
				id: "task-002",
				applicationId: "app-001",
				title: "Request reference letters",
				description: "Contact two professors",
				dueDate: "2024-10-25",
				completed: true,
			},
			{
				...
				description: "Final submission through UCAS",
				dueDate: "2024-11-01",
				completed: true,
			},
		],
		timeline: [
			{
				...
				description: "Created application draft",
			},
			{
				id: "tl-002",
				date: "2024-11-01",
		...
		tasks: [
			{
				...
				description: "Send official SAT scores",
				dueDate: "2024-10-30",
				completed: true,
			},
			{
				...
				description: "Write Stanford-specific essays",
				dueDate: "2024-11-05",
				completed: true,
			},
		],
	...
	},
	{
		...
		tasks: [
			...
			},
			{
				id: "task-007",
				applicationId: "app-003",
				title: "Write statement of intent",
				description: "Explain academic interests",
				dueDate: "2024-12-10",
				completed: false,
				priority: "high",
			},
			{
				...
				description: "Submit CAD $150 application fee",
				dueDate: "2024-12-15",
				completed: false,
				priority: "high",
			},
		...
		tasks: [
			{
				...
				description: "Request from university registrar",
				dueDate: "2024-12-01",
				completed: false,
				priority: "high",
			},
			{
				...
				description: "Apply for ETH Excellence Scholarship",
				dueDate: "2024-12-20",
				completed: false,
				priority: "medium",
			},
			{
				...
				description: "Write compelling motivation letter",
				dueDate: "2025-01-15",
				completed: false,
				priority: "high",
			},
		...
		tasks: [
			{
				...
				description: "Upload official test results",
				dueDate: "2024-11-10",
				completed: true,
			},
			{
				...
				description: "Fill out NUS application portal",
				dueDate: "2024-11-15",
				completed: true,
			},
		],
